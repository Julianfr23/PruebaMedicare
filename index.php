...
<body>
    ...
    <div  id="header"  class="bg-red-700 mx-auto text-center py-2">
    ...
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
        <h1 class=" text-center break-normal text-2xl md:text-3xl mx-auto my-4 px-2">
        Seniors On Medicare Can Get Hundreds In Savings.<strong> Tap Below To Qualify!</strong></h1>
        <img class="mx-auto my-2 w-full md:w-3/4" src="assets/images/hero.jpg" />
        <p class="my-3 md:text-xl" style="text-align: left;">
        Many elderly Americans are quickly updating their 2024 Medicare plans to obtain a $2,500 spending card. This card allows them to <strong>  purchase goods at numerous stores</strong> nationwide.
        </p>
        <p class="my-3 md:text-xl" style="text-align: left;">
        ...
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1  gap-6">
                    <button id="btn-3" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">Under 64
                    </button>
    ...
    <div id="display3" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
    <h1 class="font-bold text-center break-normal text-2xl md:text-3xl mx-auto my-4 px-2">
    ...
    <footer id="foot" class="footer mt-12 footer-center p-4 mt-12 mb-2 text-center max-w-6xl mx-auto text-xs">
        ...
        <div class="mt-8">
            <p>Copyright
                Golden Years Benefits © 2024 - All right reserved
            </p>
        </div>
    </footer>
    <script src="https://cdn.sppoints.xyz/track.js?rtkcmpid=646e2b29e54ddc000111d938"></script>
    <script>
        const setRtClickId = () => {
        ...
        const setZip = () => {
            ...
            newUrl.searchParams.set('ip_zip', "111711");
            window.history.pushState({
                path: newUrl.href
            }, '', newUrl.href);
        };
        ...
        const loadRingba = () => {
          ...
          script.src = "//b-js.ringba.com/CAb49cfcb9181147da91c79a5b41b45130";
